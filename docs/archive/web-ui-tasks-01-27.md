# Web UI Improvement Tasks 1-27 (completed)

Tasks 1 through 27 of the Web UI improvement plan, every Gate checked. They are kept
here for the reasoning behind each change; the open plan lives in `Tasks.md`.
