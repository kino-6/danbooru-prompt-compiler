...
Measured content height runs 466-800px across the seven tasks. Everything fits a 1920x1080 desktop; on a 1440x900 laptop four tasks fit and the other three run 12-70px over, and on a 1366x768 laptop the tallest run about 200px over. What falls below the fold in every case is the collapsed panels - the selector, the image, the instruction and the run button stay on screen.
